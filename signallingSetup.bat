...
powershell -Command "Start-Process 'cmd' '/c call run_local.bat --StreamerPort 8890 --HttpPort 81 --SFUPort 8891' -WorkingDirectory './PixelStreamingMultipleStatic/Windows/StaticModel/Samples/PixelStreaming/WebServers/SignallingWebServer/platform_scripts/cmd/'"
